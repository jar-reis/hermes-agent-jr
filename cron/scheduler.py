...
"""
        ...
        if defer_agent_teardown is not None:
            ...
            _teardown_cron_agent(agent, job_id, _context_snapshot_path)


def _teardown_cron_agent(agent, job_id: str, context_snapshot_path: Optional[Path] = None) -> None:
    ...
    try:
        if context_snapshot_path is not None:
            context_snapshot_path.unlink(missing_ok=True)
    except OSError as e:
